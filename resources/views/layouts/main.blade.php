...
<nav class="navbar navbar-expand-lg bg-dark">
    <div class="container-fluid">
        <a class="navbar-brand text-white" href="/">Задачник</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                @auth
                <li class="nav-item">
                    <a class="nav-link active text-white" href="{{ route('tasks.index') }}">Задачи</a>
                </li>
                @endauth
            </ul>
...
@section('scripts')
@parent
<footer class="text">Task-Manager 2023</footer>
